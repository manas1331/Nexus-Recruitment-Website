            ...
            <div className="container flex">
                ...
                <div className="navbar__collapse">
                    <ul className="navbar__nav">
                        ...
                        <li className="nav__item">
                            <a href = "#us" className = "nav__link text__upper fw_6 text__light">work</a>
                        </li>
                        <li className="nav__item">
                            <a href = "#process" className = "nav__link text__upper fw_6 text__light">process</a>
                        </li>
                        <li className="nav__item">
                            <a href = "#services" className = "nav__link text__upper fw_6 text__light">services</a>
                        </li>
                        <li className="nav__item">
                            <a href = "#testinomials" className = "nav__link text__upper fw_6 text__light">testimonials</a>
                        </li>
                        <li className="nav__item">
