            ...
            <div className="container">
                <div className="footer__content grid text__light text__center">
                    <div className="footer__content--item">
                        <a href = "#" className="footer__navlink">Nexus Club, Inc.</a>
                        <p className="para__text">&copy; 2024 Nexus Club. All rights reserved.</p>
                    </div>

                    <div className="footer__content--item">
                        <a href = "mailto:someone@gmail.com">nexus@gmail.com </a>
                        <span> +91 986 689 009</span>
                    </div>
